...
async function createNewWebsiteID(thisLocationsHostName) {
    //let newWebsiteID = uuidv4()
    let newWebsiteID = push(child(ref(db), "websitesIds")).key;
    if (newWebsiteID === null)
        newWebsiteID = uuidv4();
