...
import { DBWebsiteHomePageContentPitchCards } from './utilsAndInterfaces/interfaces';
import { Box, Button, Divider, Stack, TextField } from '@mui/material';
export function PitchCardsComponent({ pitchCards, adminEdit }: { pitchCards: DBWebsiteHomePageContentPitchCards[], adminEdit?: boolean }): JSX.Element {
    ...
    if (pitchCards) {
        ...
        for (let i = 0; i < pitchCards.length; i++) {
            pitchCardsContent.push(
                <div className="eriks-container" id={"pitchOrder" + pitchCards[i].order}>
...
export function EditPitchardTitle({ initText }: { initText: string }): JSX.Element {
...
export function EditPitchardDescription({ initText }: { initText: string }): JSX.Element {
...
export function SaveTextsButton(): JSX.Element {
    return (
